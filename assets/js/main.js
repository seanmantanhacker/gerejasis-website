...
const translations = {
  id: {
    ...
    schBusanOnlineTitle: "Komsel Daerah Busan (Online)",
    schBusanOnlineTime: "Setiap Kamis, 21:00 KST",
    schBusanOnlineDesc: "Persekutuan komsel daerah Busan yang diadakan secara online, saling menguatkan dan berbagi firman Tuhan.",
    ...
    slidePlaceholder: "Foto akan segera hadir",
  ...
  en: {
    ...
    schBusanOnlineTitle: "Busan Area Cell Group (Online)",
    schBusanOnlineTime: "Every Thursday, 21:00 KST",
    schBusanOnlineDesc: "Cell group fellowship for the Busan area held online, encouraging one another and sharing the Word of God.",
    schBibleTag: "Bible Study",
    schBibleTitle: "Bible Study",
    ...
    labelFacebook: "Facebook:",
    labelWhatsapp: "WhatsApp:",
    slidePlaceholder: "Photo coming soon",
  ...
  kr: {
    ...
    schBusanOnlineTitle: "부산 지역 권설모임 (온라인)",
    schBusanOnlineTime: "매주 목요일, 21:00 KST",
    schBusanOnlineDesc: "온라인으로 진행되는 부산 지역 권설모임으로 서로 격려하고 말씀을 나눕니다.",
    schBibleTag: "성경공부",
    schBibleTitle: "성경공부",
